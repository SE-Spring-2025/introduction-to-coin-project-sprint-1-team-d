...
public class Demo {
    ...
    private static void metallurgyDemo() {
        System.out.println("\n--- Metallurgy Strategy Pattern Demonstration ---\n");
        
        int currentYear = Calendar.getInstance().get(Calendar.YEAR);
        
        // Create a standard Penny with Copper metallurgy
        Coin standardPenny = new Penny(currentYear);
        System.out.println("Standard Penny: " + standardPenny);
        
        // Create a custom Penny with Cupro-Nickel metallurgy
        Coin customPenny = new CustomPenny(currentYear);
        System.out.println("Custom Penny with Cupro-Nickel: " + customPenny);
    }
}

/**
 * Custom Penny class that uses Cupro-Nickel metallurgy instead of Copper.
 */
class CustomPenny extends Coin {
    public CustomPenny(int year) {
